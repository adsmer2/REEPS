...
class fired_heater_oxalate(qs.SanUnit):
    ...
    time = 1.5 # time in furnace (hr) heat for 1.5-2 hrs from Qi, Dezhi - 2018
        ...
        self.F_BM = {'fired heater oxalate': 2.5} # need to confirm this
    ...
    def _run(self):
        ...
        mol_Ln2OA3 = mol_Ln/2 # two mol of Ln per mol of the precipitated complex Ln2OA3
        ...
        # Solid Mixed REE Solid
        self.outs[0].imol['Nd2O3'] = mol_Nd2O3/1000 # kmol/hr
        # theoretically there may be other metals here as well
        ...
        # self.outs[3].imass['Water'] = mol_water*18.02/1000 # kg/hr. no impact on process so disregarded
    ...
    def _cost(self):
        ...
        # Heat Utility Cost
        self.add_OPEX = {'Natural Gas 2': 7.534*10**(-6)*self.heat_duty} # 7.534E-6 $/kJ * heat duty kJ/hr = $/hr. NG price for industry July 2022 from EIA
