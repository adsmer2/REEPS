...
# param1_values = model_uncertainty.table.loc[:,'LCA'].iloc[:,2]
# param2_values = model_uncertainty.table.loc[:,'LCA'].iloc[:,3]
# param3_values = model_uncertainty.table.loc[:,'LCA'].iloc[:,7]
# param4_values = model_uncertainty.table.loc[:,'LCA'].iloc[:,0]
# param5_values = model_uncertainty.table.loc[:,'LCA'].iloc[:,4]
# param6_values = model_uncertainty.table.loc[:,'LCA'].iloc[:,10]
# param7_values = model_uncertainty.table.loc[:,'LCA'].iloc[:,12]
# param8_values = model_uncertainty.table.loc[:,'LCA'].iloc[:,8]
# param9_values = model_uncertainty.table.loc[:,'LCA'].iloc[:,17]
...
# baseline_values = [baseline_values_all.iloc[2], 
# baseline_values_all.iloc[3], 
# baseline_values_all.iloc[7], 
# baseline_values_all.iloc[0], 
# baseline_values_all.iloc[4],
# baseline_values_all.iloc[10],
# baseline_values_all.iloc[12],
# baseline_values_all.iloc[8],
# baseline_values_all.iloc[17],
# model_uncertainty.metrics_at_baseline()['TEA',:].loc['NPV15 [MM USD]']
# ]

# # Sample parameter strings with names and units
# param_strings = [model_uncertainty.table.loc[:,'LCA'].iloc[:,2].name,
#     model_uncertainty.table.loc[:,'LCA'].iloc[:,3].name,
#     model_uncertainty.table.loc[:,'LCA'].iloc[:,7].name,
#     model_uncertainty.table.loc[:,'LCA'].iloc[:,0].name,
#     model_uncertainty.table.loc[:,'LCA'].iloc[:,4].name,
#     model_uncertainty.table.loc[:,'LCA'].iloc[:,10].name,
#     model_uncertainty.table.loc[:,'LCA'].iloc[:,12].name,
#     model_uncertainty.table.loc[:,'LCA'].iloc[:,8].name,
#     model_uncertainty.table.loc[:,'LCA'].iloc[:,17].name,
...
#     # Set x-axis label to the right side with two lines
#     axs[row, col].set_xlabel(f'{param_names[i]}\n({param_units[i]})', ha='left', color=color)
#     axs[row, col].xaxis.set_label_coords(0.03, -0.42)
