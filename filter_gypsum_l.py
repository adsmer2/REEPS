...
# Create the class
class filter_gypsum_l(qs.SanUnit):
    def __init__(self, ID= '', ins=None, outs=(), thermo=None, init_with='SanStream',
    filt_rate = 1220.5, # kg/hr/m2. Filtration rate for coarse particles from Seider pg 585
    ...
    def _run(self):
        ...
        self.outs[1].imass['U'] = self.ins[0].imass['U'] # kg/hr. Amount of radinuclide leaving in the liquid outlet
