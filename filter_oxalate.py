...
class filter_oxalate(qs.SanUnit):
    ...
    vacuum_energy = 4, # kW/m2. Pressure required to create vacuum (from 2-15 kW/m2) from Hendriksson, Brandt - 2000 - focus on separation in the mining industry
    air_flow = 0.7 # normal m3/m2 filter area/min. air flow through filter cake for pump to withdraw (0.3-2.0 m3/m2 filter area/min) from Hendriksson, Brandt - 2000 - focus on separation in the mining industry
        ...
        self.F_BM = {'filter oxalate': 2.5} # need to confirm this
    ...
    def _run(self):
        ...
        self.inlet_solids = self.ins[0].imass['OA'] + self.ins[0].imass['Nd'] # kg/hr. mass of solids entering the unit
